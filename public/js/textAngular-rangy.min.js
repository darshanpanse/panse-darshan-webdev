...
h.setEndPoint(c?"EndToStart":"EndToEnd",a);var w;if(/[\r\n]/.test(q.data)){/*
                        ...
                        to use this to owner the characters moved when moving both the start and end of the range to the
 ...
 * Saves and restores customer selections using marker invisible elements in the DOM.
 *
